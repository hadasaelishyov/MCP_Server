...
import pytest
from src.core.analyzer.parser import parse_code, extract_functions
from src.core.analyzer.models import ParameterInfo
...
"""
        tree = parse_code(code)
        from src.core.analyzer.parser import extract_classes
