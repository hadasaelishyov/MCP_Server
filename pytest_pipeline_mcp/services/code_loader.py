"""Code loading utilities for services.

Loads Python source from `file_path` or a direct `code` string with basic validation.
"""
...
class CodeLoader:
    ...
    def load(
        ...
        """Load code from `file_path` (preferred) or `code` and return LoadedCode."""
