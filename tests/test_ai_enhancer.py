...
from src.generators.ai_enhancer import AIEnhancer, EnhancementResult, create_enhancer
from src.generators.base import GeneratedTestCase
...
class TestAIEnhancerFallback:
    ...
    @patch('src.generators.ai_enhancer.OpenAI')
